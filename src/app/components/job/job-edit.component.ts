...
export class JobEditComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this
      ...
      .subscribe(job => {
          ...
          this.f.event.setValue(JSON.stringify(this.job.event));
  ...
  onSubmit() {
    ...
    job.dateStart = this.id =='new' ? null : this.f.dateStart.value;
    job.dateEnd = this.id =='new' ? null : this.f.dateEnd.value;
    job.dateAdded = this.id =='new' ? null : this.f.dateAdded.value;
    job.priority = this.f.priority.value;
    job.event = JSON.parse(this.f.event.value);
